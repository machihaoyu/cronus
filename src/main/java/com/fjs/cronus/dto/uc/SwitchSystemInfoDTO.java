 ...
 */
public class SwitchSystemInfoDTO {
 ...
 /*   private String contract_abnorma;
    private String agreement_addToReceivable;
    private String product_docheck;*/
    private HashMap role_info;
    private String department_name;
    private String sub_company_name;
    private String redis_city;

  /*  public String getProduct_docheck() {
        return product_docheck;
    }

    public void setProduct_docheck(String product_docheck) {
        this.product_docheck = product_docheck;
    }*/
  ...
  /*  public String getContract_abnorma() {
        return contract_abnorma;
    }

    public void setContract_abnorma(String contract_abnorma) {
        this.contract_abnorma = contract_abnorma;
    }

    public String getAgreement_addToReceivable() {
        return agreement_addToReceivable;
    }

    public void setAgreement_addToReceivable(String agreement_addToReceivable) {
        this.agreement_addToReceivable = agreement_addToReceivable;
    }*/

    public HashMap getRole_info() {
        return role_info;
    }

    public void setRole_info(HashMap role_info) {
