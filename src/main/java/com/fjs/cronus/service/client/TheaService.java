...
@FeignClient(value = "${client.feign.thea-backend}", url = "http://192.168.3.135:8010")
public interface TheaService {
    ...
    @RequestMapping(value = "/loanConfig/v1/getConfigByName", method = RequestMethod.GET)
    public TheaApiDTO<ConfigDTO> getConfigByName(@RequestParam(value = "name")String name);
    ...
    public CriusApiDTO ModifyValueById(@RequestHeader("Authorization") String token,@RequestParam("id") Integer id, @RequestParam("value") String value);
}
