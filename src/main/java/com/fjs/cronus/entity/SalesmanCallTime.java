...
@Table(name = "salesman_call_time")
public class SalesmanCallTime {

    /**

     # 通话时长表
     CREATE TABLE `salesman_call_time` (
     ...
     PRIMARY KEY (`id`)
     ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='通话时长表';
