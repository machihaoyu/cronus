...
@Table(name = "salesman_meet_num")
public class SalesmanMeetNum {

    /**

     # 面见次数表
     CREATE TABLE `salesman_meet_num` (
     ...
     `num` int(20) DEFAULT NULL COMMENT '面见次数',
     PRIMARY KEY (`id`)
     ) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='面见次数表';
